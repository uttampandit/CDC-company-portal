...
const InfPosting = ({ posting, route, deleteCallback }) => {
              ...
              <Disclosure.Panel>
                <div className="flex flex-col pt-5 bg-white">
                  <div className="flex justify-start items-start p-2">
                    <p className="grow font-poppins text-sm font-light w-1/2">
                      <p className="font-poppins text-sm font-medium">
                        Type of Internship
                      </p>{" "}
                      {posting.typeOfInternship}
                    </p>
                    <p className="grow font-poppins text-sm font-light w-1/2">
                      <p className="font-poppins text-sm font-medium">
                        Description
